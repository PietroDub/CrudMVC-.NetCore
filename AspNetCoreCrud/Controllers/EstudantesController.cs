...
namespace AspNetCoreCrud.Controllers
{
    public class EstudantesController : Controller
    {
        ...
        {
            return View(await _context.Estudanes.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var estudante = await _context.Estudanes
        ...
        public async Task<IActionResult> Create([Bind("estudanteId,Nome,Email,Course,DataCadastro")] Estudante estudante)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var estudante = await _context.Estudanes.FindAsync(id);
            if (estudante == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("estudanteId,Nome,Email,Course,DataCadastro")] Estudante estudante)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (estudante != null)
            {
                _context.Estudanes.Remove(estudante);
            }
        ...
        {
            return _context.Estudanes.Any(e => e.estudanteId == id);
        }
    }
}
